...
def estimate_dot(q: np.ndarray, o_r: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
...
def correct_mip(q: np.ndarray, o_r: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
    ...
    est_dot, centre = estimate_dot(q, o_r)
